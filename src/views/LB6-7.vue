<template>
  <section class="container">
    ...
    <DiseaseForm
      v-model:age="disease.age"
      v-model:gender="disease.gender"
      v-model:activity="disease.activity"
      v-model:bloodPressure="disease.bloodPressure"
      v-model:bloodSugar="disease.bloodSugar"
      v-model:insulin="disease.insulin"
      v-model:restECG="disease.restECG"
      v-model:cholesterol="disease.cholesterol"
      v-model:cigaretsYears="disease.cigaretsYears"
      v-model:alcoholYears="disease.alcoholYears"
      v-model:drugs-years="disease.drugsYears"
...
export default defineComponent({
  ...
  setup() {
    ...
    const { layers } = useMatNeuronLayers({
      ...
      layersOptions: [{ neuronAmount: 8 }, { neuronAmount: 8 }],
    });
